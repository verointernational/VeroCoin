...
const QString BITCOIN_IPC_PREFIX("VeroCoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click VeroCoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start VeroCoin: click-to-pay handler");
    else
...
{
    // clicking on VeroCoin: URLs creates FileOpen events on the Mac:
